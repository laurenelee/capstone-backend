...
name_samples = ["Friends of Youth", "United Way of King County", "Project LEAD", "Youth in Focus", "FareStart", "Service Seattle", "Mary's Place", "Teen Peace Corps", "YMCA", "Clean Up Seattle", "Humane Seattle", "Big Brothers Big Sisters", "Meals on Wheels", "Teen Lifeline", "Food Lifeline", "Northwest Harvest", "PAWS", "Community Services Coalition", "Public Library", "Atlantic Street Center", "Children's Hospital", "Lifelong AIDS Alliance", "Full Life", "Nature Consortium", "Parks and Recreation", "ROOTS Young Adult"]
