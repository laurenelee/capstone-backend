...
name_data = [ Faker::VentureBros.organization, Faker::Company.name, Faker::Zelda.location, Faker::App.name, Faker::Name.name, Faker::HeyArnold.location,
Faker::Educator.campus, Faker::Commerce.department, Faker::Job.title, Faker::University.name]
